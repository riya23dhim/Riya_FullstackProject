                    ...
                    <div className="lg:col-span-4 space-y-6">
                        <div className="bg-white p-8 rounded-2xl border border-[#E5E7EB] shadow-sm text-center">
                            <div className="relative inline-block group">
                                <img
                                    src={avatarPreview ? (avatarPreview.startsWith('http') || avatarPreview.startsWith('data:') || avatarPreview.startsWith('blob:') ? avatarPreview : `${import.meta.env.VITE_API_URL}${avatarPreview}`) : '/default-avatar.png'}
                                    alt="Profile"
